...
export function handleSummary(data) {
  ...
  return {
    'k6-tests/results/purchase/step1-single-product-summary.json': JSON.stringify(data, null, 2),
    'k6-tests/results/purchase/step1-single-product-summary.html': htmlReport(metrics),
  };
}
